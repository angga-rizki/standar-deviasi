...
class Autoload extends \CodeIgniter\Config\AutoloadConfig
{
	...
	public function __construct()
	{
		 ...
		 */
		$classmap = [
                    'Spreadsheet_Excel_Reader' => APPPATH . 'Thirdparty/spreadsheet-reader-0.5.11/php-excel-reader/excel_reader2.php',
                    'SpreadsheetReader' => APPPATH . 'ThirdParty/spreadsheet-reader-0.5.11/SpreadsheetReader.php'
                ];
